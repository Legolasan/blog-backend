...
export declare class ExternalContextCreator {
    ...
    create<TParamsMetadata extends ParamsMetadata = ParamsMetadata, TContext extends ContextType = ContextType>(instance: Controller, callback: (...args: any[]) => any, methodName: string, metadataKey?: string, paramsFactory?: ParamsFactory, contextId?: import("..").ContextId, inquirerId?: string, options?: ExternalContextOptions, contextType?: TContext): (...args: any[]) => Promise<any>;
